...
const CreateRestaurant = () => {
  ...
  return (
    <>
      <div
        className="login template flex justify-center items-center min-h-screen bg-primary mt-6"
        style={{
      ...
      >
        <div className="flex flex-col sm:flex-row w-full">
          <div className="w-full sm:w-1/2 mt-[15%] sm:mt-[25%] p-8 flex flex-col">
            <h1 className="text-white text-3xl sm:text-4xl font-semibold mb-4">
              Food Mania Restaurant Creation
            </h1>
            <p className="text-white text-xl sm:text-2xl font-semibold mb-4">
              Embark on a culinary adventure with Food Mania, where every dish
              tells a story of flavor and every bite is a chapter of delight!
              🍝✨
            </p>
          </div>

          <div className="w-full sm:w-1/2 mt-[10%] mb-[10rem]">
              ...
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    placeholder="Enter restaurantPhone"
                    className="form-input w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={formik.handleChange}
                  />
                  {formik.touched.restaurantPhone &&
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={formik.handleChange}
                  />
                  {formik.touched.restaurantEmail &&
                ...
                <div className="mb-4">
                  <label htmlFor="image" className="block text-gray-800">
                    Upload Image (Image must be aesthetic)
                  </label>
                  <input
                    type="file"
                ...
                <div className="grid mt-4">
                  <button className="btn btn-primary bg-[#FEC013] py-2 rounded-lg">
                    Create Restaurant
                  </button>
                </div>
              </form>
